# from url: https://www.codingforentrepreneurs.com/blog/python-jwt-client-django-rest-framework-simplejwt/
...
class JWTClient:
    ...
    # this assumesy ou have DRF running on localhost:8000 (chaged)
